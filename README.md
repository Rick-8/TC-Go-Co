...
>> ### **Admin option 1**
View/Update Exchange Rates, is an upcomming feature.

![Admin option 1](assets/images/tc-admin-option1.webp)

>> ### **Admin option2**
Manage Currency Stock, allows the user to add or remove stock with out the need to make a sale.
...
>> ### **Admin option 3**
View Transaction Logs is an up comming feature that will allow the use of currency tracking and auditing.
...
> ### **Customer Menu**
 ...
 rates. it also has the Till option to sell currency wit the option print receipts if required.
...
> ## Content
I used [Lucid.app](https://lucid.app/) to plot a flow chart.